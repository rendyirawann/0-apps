...
/**
 * Tiga kegiatan contoh beserta arus kas dan rincian bahan bakunya.
 *
 * Dipisah dari DatabaseSeeder supaya bisa dijalankan sendiri:
 *
 *   php artisan db:seed --class=KegiatanContohSeeder
 *
 * dan supaya server bisa diisi akun serta data master TANPA ikut membawa
 * data contoh -- yang di sana hanya akan mengotori laporan.
 */
class KegiatanContohSeeder extends Seeder
{
